...
enum L10n {
    static func text(_ key: L10nKey, language: AppLanguage) -> String {
        ...
        case (.printSettingsHint, .chinese): return "PDF 和图片会优先使用这些设置；Word 文档会先转成临时 PDF，再用相同设置打印。"
        case (.printSettingsHint, .english): return "PDF and images use these settings first; Word documents are converted to temporary PDFs before printing."
        ...
        case (.officeCapabilityMessage, .chinese): return "Word 文档支持通过 Microsoft Word、Pages 或 LibreOffice 转 PDF 后打印。"
        case (.officeCapabilityMessage, .english): return "Word documents can be converted to PDF through Microsoft Word, Pages, or LibreOffice before printing."
